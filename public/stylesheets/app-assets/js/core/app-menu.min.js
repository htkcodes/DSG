    ...
    a.app.menu = {
        ...
        manualScroller: {
            ...
            update: function() {
                if (this.obj) {
                    var e;
                    if (!0 === a(".main-menu").data("scroll-to-active")) e = a(".main-menu-content").find("li.active").parents("li").length > 0 ? a(".main-menu-content").find("li.active").parents("li").last().position() : a(".main-menu-content").find("li.active").position(), setTimeout(function() {
        ...
        init: function(e) {
            if (a(".main-menu-content").length > 0) {
                ...
                if (!0 === e && (n = "collapsed"), "vertical-menu-modern" == t.data("menu")) {
                    var i = "";
                    "undefined" != typeof Storage && (i = localStorage.getItem("menuLocked")), "false" === i ? this.change("collapsed") : this.change()
                } else this.change(n)
        ...
        change: function(e) {
            ...
            "vertical-menu" !== o && "vertical-compact-menu" !== o && "vertical-content-menu" !== o && "vertical-menu-modern" !== o || this.toOverlayMenu(n.name), t.is(".horizontal-layout") && !t.hasClass(".horizontal-menu-demo") && (this.changeMenu(n.name), a(".menu-toggle").removeClass("is-active")), "horizontal-menu" != o && this.drillDownMenu(n.name), "xl" == n.name && (a('body[data-open="hover"] .dropdown').on("mouseenter", function() {
            ...
            }), "horizontal-menu" == o && ("sm" == n.name || "xs" == n.name ? a(".menu-fixed").length && a(".menu-fixed").unstick() : a(".navbar-fixed").length && a(".navbar-fixed").sticky()), "vertical-menu" !== o && "vertical-overlay-menu" !== o && "vertical-content-menu" !== o || (jQuery.expr[":"].Contains = function(e, n, a) {
